...
def test_grid_ds(filepath):
    g1 = GRID(data_filename=filepath, ds_lon_name="lon", ds_lat_name="lat", ds_z_name="depth")
    ds = xr.open_dataset(filepath)
    xr.testing.assert_identical(g1.ds, ds)


# def test_synthetic_regrid():
#    g1 = GRID(data_filename="ds1_crop.nc", ds_lon_name="lon", ds_lat_name="lat", ds_z_name="depth")
#    g2 = GRID(data_filename="ds2.nc", ds_lon_name="lon", ds_lat_name="lat", ds_z_name="depth")
...
#    g1 = GRID(data_filename="ds1_64.nc", ds_lon_name="lon", ds_lat_name="lat", ds_z_name="depth")
#    g2 = GRID(data_filename="ds2.nc", ds_lon_name="lon", ds_lat_name="lat", ds_z_name="depth")
